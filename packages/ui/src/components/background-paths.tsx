      ...
      <div className="container relative z-10 mx-auto px-4 text-center md:px-6">
        ...
        >
          ...
          {/* <div className="group relative inline-block overflow-hidden rounded-2xl bg-gradient-to-b from-black/10 to-white/10 p-px shadow-lg backdrop-blur-lg transition-shadow duration-300 hover:shadow-xl dark:from-white/10 dark:to-black/10">
            <Button
              variant="ghost"
              className="group-hover:-translate-y-0.5 rounded-[1.15rem] border border-black/10 bg-white/95 px-8 py-6 font-semibold text-black text-lg backdrop-blur-md transition-all duration-300 hover:bg-white/100 hover:shadow-md dark:border-white/10 dark:bg-black/95 dark:text-white dark:hover:bg-black/100 dark:hover:shadow-neutral-800/50"
            >
